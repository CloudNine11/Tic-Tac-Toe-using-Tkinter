...
def buttonClick(buttons):
    global bclick, flag, player1_name, player2_name, player1, player2
    if buttons["text"] == " " and bclick == True:
        buttons["text"] = "X"
        bclick = False
        player2 = p2.get() + " is Winner🦾 "
        player1 = p1.get() + " is Winner 🦾 "
        checkforwin()
        flag += 1
...
def checkforwin():
    if(button1['text'] == "X" and button2['text'] == "X" and button3['text'] == "X" or
        ...
        tkinter.messagebox.showinfo("Tic Tac Toe", "Match Tie ! ")
